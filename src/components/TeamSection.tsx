...
const TeamSection = () => {
  ...
  const githubUsers = [
    { login: 'akshat2474', linkedinUrl: 'https://www.linkedin.com/in/akshat-singh-48a03b312/' },
    { login: 'ABHAY-SINGH-CODER', linkedinUrl: 'https://www.linkedin.com/in/abhaydilipsingh/' },
    { login: 'Amaan3073', linkedinUrl: 'https://www.linkedin.com/in/amaan-ali-768b32322/' },
    { login: 'GithubAnant', linkedinUrl: 'https://www.linkedin.com/in/anantsinghal1/' }
  ];

  useEffect(() => {
    const fetchTeamMembers = async () => {
      try {
        const promises = githubUsers.map(async (user) => {
